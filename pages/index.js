...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Monzwear App</title>
        <meta name="description" content="Monzwear App" />
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Menswear and Formalwear with Slaters</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want? What do you want? so why not wear cloth ??</p>
    </div>
